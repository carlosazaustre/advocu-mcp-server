/**
 * @fileoverview Country codes for geographic location
 * @description Enum defining all available countries for activity location specification
 */

/**
 * Enum for country selection in activities
 * Used to specify the country where in-person or hybrid events take place
 * Contains 251 country values following ISO standard naming conventions
 */
export enum Country {
  ...
  COMOROS = "Comoros",
  CONGO = "Congo",
  CONGO_DRC = "Congo (Democratic Republic of the)",
